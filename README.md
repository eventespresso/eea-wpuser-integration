EE WP User Integration Add-on
=========

[![Latest Release](https://img.shields.io/github/tag/eventespresso/eea-wpuser-integration.svg?style=flat&label=Latest%20Release)](https://github.com/eventespresso/eea-wpuser-integration/releases)
...
**Documentation** | [View Documentation →](https://eventespresso.com/wiki/wp-user-integration?utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=view+addon+documentation)
